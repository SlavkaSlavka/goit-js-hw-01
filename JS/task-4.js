...
droidsQuantity = prompt('Сколько?');

if (droidsQuantity === null) {
  console.log('Отменено пользователем!');
} else {
  droidsPrice = droidsQuantity * pricePerDroid;
}
console.log(droidsPrice);
if (droidsPrice > credits) {
  console.log ('Недостаточно средств на счету!')
} else {
  console.log(`Вы купили ${droidsQuantity} дроидов, на счету осталось ${credits - droidsPrice} кредитов`);
}
