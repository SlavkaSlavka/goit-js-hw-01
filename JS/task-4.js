...
//значение хранится в переменной credits (создай и присвой). Пользователь решает купить ремонтных дроидов,
...
let droidsQuantity;
let totalPrice;
droidsQuantity = prompt('Сколько Вы хотите купить дроидов?');

if (droidsQuantity === null) {
  totalPrice = 'Отменено пользователем'
} else if (isNaN(droidsQuantity) === true) {
  totalPrice = `Пользователь ввёл ${droidsQuantity} , это не число`;
}
else {
...
if (totalPrice > credits) {
  ...
  console.log (`Вы купили ${droidsQuantity} дроидов, на счету осталось ${totalPrice} кредитов.`)  
